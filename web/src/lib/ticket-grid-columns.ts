...
export const TICKET_GRID_COLUMNS: TicketGridColumnDef[] = [
  ...
  { key: "id", label: "#", defaultVisible: true, canHide: false, minWidth: 88 },
  { key: "status", label: "Status", defaultVisible: true, canHide: true, minWidth: 72 },
  { key: "priority", label: "Prio", defaultVisible: true, canHide: true, minWidth: 44 },
  { key: "type", label: "Tip", defaultVisible: true, canHide: true, minWidth: 40 },
  { key: "subject", label: "Subiect", defaultVisible: true, canHide: false, minWidth: 140 },
  { key: "client", label: "Client", defaultVisible: true, canHide: true, minWidth: 72 },
  { key: "vehicle", label: "Vehicul", defaultVisible: true, canHide: true, minWidth: 88 },
  { key: "driver", label: "Șofer", defaultVisible: true, canHide: true, minWidth: 100 },
  { key: "routing", label: "Nivel", defaultVisible: true, canHide: true, minWidth: 44 },
  { key: "owner", label: "Owner", defaultVisible: true, canHide: true, minWidth: 96 },
  { key: "age", label: "Vârstă", defaultVisible: true, canHide: true, minWidth: 56 },
  { key: "updated", label: "Actualizat", defaultVisible: false, canHide: true, minWidth: 80 },
  { key: "created", label: "Creat", defaultVisible: false, canHide: true, minWidth: 80 },
  { key: "resolved", label: "Rezolvat", defaultVisible: false, canHide: true, minWidth: 80 },
  { key: "queue", label: "Coadă", defaultVisible: false, canHide: true, minWidth: 88 },
  { key: "km", label: "Km", defaultVisible: false, canHide: true, minWidth: 64 },
  { key: "actions", label: "Acțiuni", defaultVisible: true, canHide: false, minWidth: 120 },
];
