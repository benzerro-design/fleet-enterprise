    ...
    <div className="space-y-8">
      <div className="rounded-lg border border-sky-900/40 bg-sky-950/20 p-4">
        ...
        <p className="mt-2 text-xs text-zinc-500">
          Singurul loc unde se actualizează odometrul vehiculului. Costurile și mentenanța pot înregistra km la
          eveniment, fără a modifica km-ul oficial al mașinii.
        </p>
      </div>
