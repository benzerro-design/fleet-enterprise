...
import { WORK_ORDER_GLYPH_LEGEND } from "@/components/fleet/work-orders/WorkOrderListGlyphs";

type Props = { onClose: () => void };

export function WorkOrderGlyphLegendPanel({ onClose }: Props) {
  return (
    <div className="rounded-xl border border-zinc-700 bg-zinc-950 p-4 shadow-xl">
      ...
      <div className="grid max-h-80 gap-4 overflow-y-auto sm:grid-cols-2">
        {WORK_ORDER_GLYPH_LEGEND.map((section) => (
